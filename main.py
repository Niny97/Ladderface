...
level_buttons = pygame.image.load("levels_buttons.png")
paused_buttons = pygame.image.load("pausedbuttons.png")
button_rects = {
...
level_menu_image = pygame.image.load("levels_background.png")
...
about_button = Button(screen, button_rects[2], 315, 401, "about", buttons, "")
...
back_button = Button(screen, button_rects[7], 370, 458, "back", buttons, "menu")
levels_menu = Menu(screen, level_menu_image, [level1_button, level2_button, level3_button, back_button])
